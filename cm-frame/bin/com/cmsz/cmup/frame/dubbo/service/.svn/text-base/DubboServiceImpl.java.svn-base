...
/**
 * 子系统对外dubbo接口通用实现类
 * 所有子系统对外提供的dubbo接口实现类需要继承此类，不需要自己添加和修改任何方法，
...
public class DubboServiceImpl implements DubboService{
	 ...
	 */
	@Override
	public ReturnResult doDubboService(Map<String, String> variableMap) {
		...
		//取到服务名
		String serviceName = variableMap.get(FrameConstant.SERVICENAME);
